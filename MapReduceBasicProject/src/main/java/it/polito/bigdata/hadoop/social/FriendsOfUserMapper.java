...
// Mapper for 'friends of' query: emit friend -> user for every pair, both directions
public class FriendsOfUserMapper extends Mapper<LongWritable, Text, Text, Text> {
    @Override
