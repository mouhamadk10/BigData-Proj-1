# Exercise 22: Stopword Elimination

## Description
This exercise implements a MapReduce job for stopword elimination.

## Files
- `StopwordEliminationDriver` - MapReduce Driver class
...
# Upload input file(s)
cd exercise_22
hdfs dfs -put input.txt /user/$USER/exercise_22/input/
```
...
hadoop jar target/MapReduceProject-1.0.0.jar \
  it.polito.bigdata.hadoop.stopword.StopwordEliminationDriver \
  2 \
